...
Yes you can convert a process into service but applications nowdays installation scripts such as application server and websever are starting thier application as processes.
